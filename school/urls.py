...
urlpatterns = [
    ...
    path('packages/', views.schoolpackages, name="schoolpackages"),
    ...
    path('parents/attendanceview/<int:pk>/', views.parent_attendance_view, name='parent_attendance_view'),
    path('parents/add/new/', views.ParentAddView.as_view(), name="add_new_parent"),
    path('parents/child/add/<int:pk>/', views.ParentChildrenAddView.as_view(), name="add_new_parents_child"),
    ...
    path('attendance/classes/archive/<int:class_id>/', views.student_attendance_archive,
         name='student_attendance_archive'),
